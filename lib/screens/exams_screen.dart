                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          l10n?.manageShares ?? 'Manage Shared Exams',
                        ...
                        onDelete: () async {
                          final confirm = await showDialog<bool>(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Text(
                                'This will prevent others from using code "${code.shareCode}" to add this exam. '
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            '${widget.code.itemCount} questions',
                            style: TextStyle(
                              color: colorScheme.primary,
                              fontWeight: FontWeight.w500,
                            ),
